...
public class LotoNumeros {

    private static final int TAM_POPULACAO = 500; // Tamanho da população
    private static final int NUM_GERACOES = 200; // Número máximo de gerações
    private static final double TAXA_MUTACAO = 0.05; // Taxa de mutação
    private static final double TAXA_REPRODUCAO = 1.0; // Taxa de crossover
    private static final int ELITISMO = 250; // Número de indivíduos que serão mantidos na próxima geração
    private static final int VALOR_FITNESS_DESEJADO = 400; // Valor de fitness desejado
    ...
    private static ArrayList<Double> calculaFitness(ArrayList<int[]> populacao) {
        ...
        for (int[] individual : populacao) {
            ...
            //Valoriza o indivíduo se a soma estiver entre 190 e 260
     ...
     * reprodução definida pelo parâmetro TAXA_REPRODUCAO.
     *
    ...
    public static void main(String[] args) {
        ...
        /**
         * Inicializa a população aleatoriamente, com tamanho da população definido
         * por "TAM_POPULACAO" e armazena a população em array list (populacao)
         */
        ...
        /**
         * Executa as gerações Loop limitado por "NUM_GERACOES"
         */
        int contadorGeracoes = 0;
        while (contadorGeracoes < NUM_GERACOES) {
            /**
            ...
            // Se encontrar um indivíduo com o fitness desejado(definido pela constante VALOR_FITNESS_DESEJADO), 
            ...
            int melhoresNumeros = valoresFitness.indexOf((double) VALOR_FITNESS_DESEJADO);
